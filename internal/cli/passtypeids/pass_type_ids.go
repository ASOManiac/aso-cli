...
func PassTypeIDsCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "pass-type-ids",
		ShortUsage: "aso pass-type-ids <subcommand> [flags]",
		ShortHelp:  "Manage pass type IDs.",
		LongHelp: `Manage pass type IDs.

Examples:
  aso pass-type-ids list
  aso pass-type-ids get --pass-type-id "PASS_ID"
  aso pass-type-ids create --identifier "pass.com.example" --name "Example"
  aso pass-type-ids update --pass-type-id "PASS_ID" --name "New Name"
  aso pass-type-ids delete --pass-type-id "PASS_ID" --confirm
...
func PassTypeIDsListCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "list",
		ShortUsage: "aso pass-type-ids list [flags]",
		ShortHelp:  "List pass type IDs.",
		LongHelp: `List pass type IDs.

Examples:
  aso pass-type-ids list
  aso pass-type-ids list --id "PASS_ID"
  aso pass-type-ids list --identifier "pass.com.example"
  aso pass-type-ids list --name "Example"
  aso pass-type-ids list --paginate`,
		FlagSet:   fs,
		UsageFunc: shared.DefaultUsageFunc,
		Exec: func(ctx context.Context, args []string) error {
...
func PassTypeIDsGetCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "get",
		ShortUsage: "aso pass-type-ids get --pass-type-id \"PASS_ID\"",
...
func PassTypeIDsCreateCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "create",
		ShortUsage: "aso pass-type-ids create --identifier \"pass.com.example\" --name \"Example\"",
...
func PassTypeIDsUpdateCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "update",
		ShortUsage: "aso pass-type-ids update --pass-type-id \"PASS_ID\" --name \"New Name\"",
...
func PassTypeIDsDeleteCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "delete",
		ShortUsage: "aso pass-type-ids delete --pass-type-id \"PASS_ID\" --confirm",
