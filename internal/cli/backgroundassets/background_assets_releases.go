...
func BackgroundAssetsAppStoreReleasesCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		...
		ShortUsage: "aso background-assets app-store-releases <subcommand> [flags]",
...
func BackgroundAssetsAppStoreReleasesGetCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "get",
		ShortUsage: "aso background-assets app-store-releases get --id \"RELEASE_ID\"",
...
func BackgroundAssetsExternalBetaReleasesCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		...
		ShortUsage: "aso background-assets external-beta-releases <subcommand> [flags]",
		ShortHelp:  "Get external beta releases for background assets.",
		LongHelp: `Get external beta releases for background assets.

Examples:
  aso background-assets external-beta-releases get --id "RELEASE_ID"`,
		FlagSet:   fs,
		UsageFunc: shared.DefaultUsageFunc,
		Subcommands: []*ffcli.Command{
...
func BackgroundAssetsExternalBetaReleasesGetCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "get",
		ShortUsage: "aso background-assets external-beta-releases get --id \"RELEASE_ID\"",
...
func BackgroundAssetsInternalBetaReleasesCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		...
		ShortUsage: "aso background-assets internal-beta-releases <subcommand> [flags]",
		ShortHelp:  "Get internal beta releases for background assets.",
		LongHelp: `Get internal beta releases for background assets.

Examples:
  aso background-assets internal-beta-releases get --id "RELEASE_ID"`,
		FlagSet:   fs,
		UsageFunc: shared.DefaultUsageFunc,
		Subcommands: []*ffcli.Command{
...
func BackgroundAssetsInternalBetaReleasesGetCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "get",
		ShortUsage: "aso background-assets internal-beta-releases get --id \"RELEASE_ID\"",
