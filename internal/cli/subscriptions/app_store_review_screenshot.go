...
func SubscriptionsAppStoreReviewScreenshotCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		...
		ShortUsage: "aso subscriptions app-store-review-screenshot <subcommand> [flags]",
...
Examples:
  aso subscriptions app-store-review-screenshot get --subscription-id "SUBSCRIPTION_ID"`,
		FlagSet:   fs,
...
func SubscriptionsAppStoreReviewScreenshotGetCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "get",
		ShortUsage: "aso subscriptions app-store-review-screenshot get --subscription-id \"SUBSCRIPTION_ID\"",
