...
func AnalyticsSegmentsCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "segments",
		ShortUsage: "aso analytics segments <subcommand> [flags]",
		ShortHelp:  "Get analytics report segments by ID.",
		LongHelp: `Get analytics report segments by ID.

Examples:
  aso analytics segments get --segment-id "SEGMENT_ID"`,
		FlagSet:   fs,
...
func AnalyticsSegmentsGetCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "get",
		ShortUsage: "aso analytics segments get --segment-id \"SEGMENT_ID\" [flags]",
