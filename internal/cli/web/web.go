...
func WebCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "web",
		ShortUsage: "aso web <subcommand> [flags]",
...
These commands can break without notice and are intentionally detached from official aso workflows.
Use ` + "`aso web apps create`" + ` as the canonical app-creation command when you need this unofficial path.
...
Examples:
  ...
  aso web review list --app "123456789" --apple-id "user@example.com"
  aso web review show --app "123456789" --apple-id "user@example.com"
  aso web review subscriptions list --app "123456789" --apple-id "user@example.com"
  aso web analytics overview --app "123456789" --start 2025-12-24 --end 2026-03-23`,
		FlagSet:   fs,
