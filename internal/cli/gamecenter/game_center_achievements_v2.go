...
func GameCenterAchievementsV2Command() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "v2",
		ShortUsage: "aso game-center achievements v2 <subcommand> [flags]",
		ShortHelp:  "Manage Game Center achievements v2 resources.",
		LongHelp: `Manage Game Center achievements v2 resources.

Examples:
  aso game-center achievements v2 list --app "APP_ID"
  aso game-center achievements v2 versions list --achievement-id "ACH_ID"
  aso game-center achievements v2 localizations list --version-id "VER_ID"
  aso game-center achievements v2 images upload --localization-id "LOC_ID" --file "path/to/image.png"`,
		FlagSet:   fs,
...
func GameCenterAchievementsV2ListCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "list",
		ShortUsage: "aso game-center achievements v2 list [flags]",
...
Examples:
  aso game-center achievements v2 list --app "APP_ID"
  aso game-center achievements v2 list --group-id "GROUP_ID"
  aso game-center achievements v2 list --app "APP_ID" --paginate`,
		FlagSet:   fs,
		UsageFunc: shared.DefaultUsageFunc,
		Exec: func(ctx context.Context, args []string) error {
...
func GameCenterAchievementVersionsV2Command() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "versions",
		ShortUsage: "aso game-center achievements v2 versions <subcommand> [flags]",
		ShortHelp:  "Manage Game Center achievement versions (v2).",
		LongHelp: `Manage Game Center achievement versions (v2).

Examples:
  aso game-center achievements v2 versions list --achievement-id "ACH_ID"
  aso game-center achievements v2 versions get --id "VERSION_ID"
  aso game-center achievements v2 versions create --achievement-id "ACH_ID"`,
		FlagSet:   fs,
		UsageFunc: shared.DefaultUsageFunc,
		Subcommands: []*ffcli.Command{
...
func GameCenterAchievementVersionsV2ListCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "list",
		ShortUsage: "aso game-center achievements v2 versions list --achievement-id \"ACH_ID\"",
		ShortHelp:  "List versions for a Game Center achievement (v2).",
		LongHelp: `List versions for a Game Center achievement (v2).

Examples:
  aso game-center achievements v2 versions list --achievement-id "ACH_ID"
  aso game-center achievements v2 versions list --achievement-id "ACH_ID" --paginate`,
		FlagSet:   fs,
		UsageFunc: shared.DefaultUsageFunc,
		Exec: func(ctx context.Context, args []string) error {
			if *limit != 0 && (*limit < 1 || *limit > 200) {
...
func GameCenterAchievementVersionsV2GetCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "get",
		ShortUsage: "aso game-center achievements v2 versions get --id \"VERSION_ID\"",
...
func GameCenterAchievementVersionsV2CreateCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "create",
		ShortUsage: "aso game-center achievements v2 versions create --achievement-id \"ACH_ID\"",
...
func GameCenterAchievementLocalizationsV2Command() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "localizations",
		ShortUsage: "aso game-center achievements v2 localizations <subcommand> [flags]",
		ShortHelp:  "Manage Game Center achievement localizations (v2).",
		LongHelp: `Manage Game Center achievement localizations (v2).

Examples:
  aso game-center achievements v2 localizations list --version-id "VER_ID"
  aso game-center achievements v2 localizations create --version-id "VER_ID" --locale en-US --name "First Win" --before-earned-description "Before" --after-earned-description "After"`,
		FlagSet:   fs,
		UsageFunc: shared.DefaultUsageFunc,
		Subcommands: []*ffcli.Command{
...
func GameCenterAchievementLocalizationsV2ListCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "list",
		ShortUsage: "aso game-center achievements v2 localizations list --version-id \"VER_ID\"",
		ShortHelp:  "List localizations for an achievement version (v2).",
		LongHelp: `List localizations for an achievement version (v2).

Examples:
  aso game-center achievements v2 localizations list --version-id "VER_ID"
  aso game-center achievements v2 localizations list --version-id "VER_ID" --paginate`,
		FlagSet:   fs,
		UsageFunc: shared.DefaultUsageFunc,
		Exec: func(ctx context.Context, args []string) error {
			if *limit != 0 && (*limit < 1 || *limit > 200) {
...
func GameCenterAchievementLocalizationsV2GetCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "get",
		ShortUsage: "aso game-center achievements v2 localizations get --id \"LOC_ID\"",
...
Examples:
  aso game-center achievements v2 localizations get --id "LOC_ID"`,
		FlagSet:   fs,
		UsageFunc: shared.DefaultUsageFunc,
		Exec: func(ctx context.Context, args []string) error {
...
func GameCenterAchievementLocalizationsV2CreateCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "create",
		ShortUsage: "aso game-center achievements v2 localizations create --version-id \"VER_ID\" --locale \"LOCALE\" --name \"NAME\" --before-earned-description \"TEXT\" --after-earned-description \"TEXT\"",
...
func GameCenterAchievementLocalizationsV2UpdateCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "update",
		ShortUsage: "aso game-center achievements v2 localizations update --id \"LOC_ID\" [flags]",
		ShortHelp:  "Update a Game Center achievement localization (v2).",
		LongHelp: `Update a Game Center achievement localization (v2).

Examples:
  aso game-center achievements v2 localizations update --id "LOC_ID" --name "New Name"`,
		FlagSet:   fs,
		UsageFunc: shared.DefaultUsageFunc,
		Exec: func(ctx context.Context, args []string) error {
			id := strings.TrimSpace(*localizationID)
...
func GameCenterAchievementLocalizationsV2DeleteCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "delete",
		ShortUsage: "aso game-center achievements v2 localizations delete --id \"LOC_ID\" --confirm",
		ShortHelp:  "Delete a Game Center achievement localization (v2).",
		LongHelp: `Delete a Game Center achievement localization (v2).

Examples:
  aso game-center achievements v2 localizations delete --id "LOC_ID" --confirm`,
		FlagSet:   fs,
		UsageFunc: shared.DefaultUsageFunc,
		Exec: func(ctx context.Context, args []string) error {
			id := strings.TrimSpace(*localizationID)
...
func GameCenterAchievementImagesV2Command() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "images",
		ShortUsage: "aso game-center achievements v2 images <subcommand> [flags]",
...
Examples:
  aso game-center achievements v2 images upload --localization-id "LOC_ID" --file "path/to/image.png"
  aso game-center achievements v2 images get --id "IMAGE_ID"
  aso game-center achievements v2 images get --localization-id "LOC_ID"
  aso game-center achievements v2 images delete --id "IMAGE_ID" --confirm`,
		FlagSet:   fs,
		UsageFunc: shared.DefaultUsageFunc,
		Subcommands: []*ffcli.Command{
...
func GameCenterAchievementImagesV2UploadCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "upload",
		ShortUsage: "aso game-center achievements v2 images upload --localization-id \"LOC_ID\" --file \"path/to/image.png\"",
...
func GameCenterAchievementImagesV2GetCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "get",
		ShortUsage: "aso game-center achievements v2 images get --id \"IMAGE_ID\" | --localization-id \"LOC_ID\"",
...
func GameCenterAchievementImagesV2DeleteCommand() *ffcli.Command {
	...
	return &ffcli.Command{
		Name:       "delete",
		ShortUsage: "aso game-center achievements v2 images delete --id \"IMAGE_ID\" --confirm",
